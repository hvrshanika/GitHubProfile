...
public struct RepositoryFragment: GraphQLFragment {
  ...
  public init(name: String, description: String? = nil, stargazerCount: Int, primaryLanguage: PrimaryLanguage? = nil, owner: Owner) {
    self.init(unsafeResultMap: ["__typename": "Repository", "name": name, "description": description, "stargazerCount": stargazerCount, "primaryLanguage": primaryLanguage.flatMap { (value: PrimaryLanguage) -> ResultMap in value.resultMap }, "owner": owner.resultMap])
  }
